...
public class TW_03_LogIn {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException 
	{
		...
		String userId = workbook.getSheet("Sheet2").getRow(7).getCell(6).getStringCellValue();
		WebElement userIdFeild = driver.findElement(By.xpath("//input[@name='text']"));
		explicitwait.until(ExpectedConditions.visibilityOf(userIdFeild));
		driver.findElement(By.xpath("//input[@name='text']"));
		userIdFeild.sendKeys(userId);
		if(userIdFeild.getAttribute("value").equals(userId))
		{
			System.out.println("Correct User ID is entered");
		}
		else
		{
			System.out.println("Incorrect User Id is entered");
		}
		...
		WebElement passwordpage = driver.findElement(By.xpath("//span[text()='Enter your password']"));
		...
		String password = workbook.getSheet("Sheet2").getRow(8).getCell(6).getStringCellValue();
		WebElement passwordFeild = driver.findElement(By.xpath("//input[@autocomplete='current-password']"));
		passwordFeild.sendKeys(password);
		if(passwordFeild.getAttribute("value").equals(password))
		{
